    ...
    <div className="container mx-auto px-4 py-8 max-w-5xl">
          ...
          <Card className="bg-slate-50 border-slate-200">
            <CardContent className="p-6">
              ...
              <ul className="text-slate-800 space-y-2">
                <li>• Means &quot;restoration of harmony&quot;</li>
                <li>• Has &quot;i&quot; in the middle</li>
                <li>• Related to &quot;reconcile&quot;</li>
          ...
          <Card className="bg-gray-50 border-gray-200">
            <CardContent className="p-6">
              ...
              <ul className="text-gray-800 space-y-2">
                <li>• From Latin &quot;reconciliatio&quot;</li>
                <li>• Related to &quot;reconcile&quot;</li>
                <li>• Always has &quot;i&quot;</li>
          ...
          <div>
            ...
            <div className="space-y-4">
              <div className="bg-red-50 p-4 rounded-lg border-l-4 border-red-500">
                <p className="text-lg text-red-800">&quot;The <strong>reconcilation</strong> of differences&quot; ❌</p>
                <p className="text-sm text-red-600 mt-1">Should be: &quot;reconciliation&quot;</p>
              </div>
              <div className="bg-red-50 p-4 rounded-lg border-l-4 border-red-500">
                <p className="text-lg text-red-800">&quot;A process of <strong>reconcilation</strong>&quot; ❌</p>
                <p className="text-sm text-red-600 mt-1">Should be: &quot;reconciliation&quot;</p>
              </div>
              <div className="bg-red-50 p-4 rounded-lg border-l-4 border-red-500">
                <p className="text-lg text-red-800">&quot;National <strong>reconcilation</strong> efforts&quot; ❌</p>
                <p className="text-sm text-red-600 mt-1">Should be: &quot;reconciliation&quot;</p>
              </div>
              <div className="bg-red-50 p-4 rounded-lg border-l-4 border-red-500">
                <p className="text-lg text-red-800">&quot;Family <strong>reconcilation</strong> meeting&quot; ❌</p>
                <p className="text-sm text-red-600 mt-1">Should be: &quot;reconciliation&quot;</p>
              </div>
            </div>
          </div>
          ...
          <div className="grid md:grid-cols-2 gap-8">
            <div>
              ...
              <ul className="space-y-3 text-lg text-gray-700">
                <li>• <strong>Reconciliation of differences</strong> - resolving conflicts</li>
                <li>• <strong>Process of reconciliation</strong> - reconciliation steps</li>
                <li>• <strong>National reconciliation</strong> - country-wide healing</li>
                <li>• <strong>Family reconciliation</strong> - family healing</li>
                <li>• <strong>Truth and reconciliation</strong> - truth commission</li>
                <li>• <strong>Reconciliation efforts</strong> - healing attempts</li>
              </ul>
            </div>
            <div>
              <h3 className="text-2xl font-bold text-gray-800 mb-4">Grammatical Functions</h3>
              <ul className="space-y-3 text-lg text-gray-700">
                <li>• <strong>Noun:</strong> &quot;The reconciliation was successful&quot;</li>
                <li>• <strong>With articles:</strong> &quot;A reconciliation&quot;</li>
                <li>• <strong>With adjectives:</strong> &quot;National reconciliation&quot;</li>
                <li>• <strong>With prepositions:</strong> &quot;Reconciliation between&quot;</li>
                <li>• <strong>With verbs:</strong> &quot;Seek reconciliation&quot;</li>
                <li>• <strong>Countable:</strong> &quot;Many reconciliations&quot;</li>
              </ul>
            </div>
          </div>
        </div>
      ...
      <div className="bg-gradient-to-r from-slate-600 to-gray-600 text-white p-8 rounded-2xl text-center">
        ...
        <div className="bg-black bg-opacity-20 p-4 rounded-lg inline-block">
          <p className="text-lg font-semibold">💡 Pro Tip: Think &quot;RECONCILE + ATION&quot; - &quot;reconciliation&quot; has &quot;i&quot; in the middle!</p>
        </div>
      </div>
