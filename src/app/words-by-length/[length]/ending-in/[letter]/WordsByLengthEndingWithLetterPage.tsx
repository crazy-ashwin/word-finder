...
export default function WordsByLengthEndingWithLetterPage({ length, letter }: Props) {
            ...
            <div className='bg-white rounded-xl shadow-lg p-8 border border-gray-100'>
              <div className='bg-white border border-gray-300 rounded-xl p-8 mb-4 shadow flex flex-col gap-2'>
                <h1 className='text-4xl font-bold mb-2'>
                  {length} Letter Words that End in{" "}
                  {letter.toUpperCase()}
                </h1>
                <p className='mb-2'>
                  ...
                  . Try our{" "}
                  <a
                    href={`/words-by-length/5/ending-in/${letter.toUpperCase()}`}
                    className='text-blue-600 hover:underline'>
                    five letter words ending with{" "}
