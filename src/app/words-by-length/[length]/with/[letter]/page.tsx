...
export default function WordsByLengthWithPage({
	...
	return (
		<div className='min-h-screen bg-gradient-to-b from-gray-50 to-white py-8'>
			<head>
				<title>{wordLength} Letter Words with {letter.toUpperCase()}</title>
				<meta
					name='description'
					content={`Find ${wordLength} letter words that contain the letter ${letter.toUpperCase()}`}
				/>
				<meta
					name='keywords'
					content={`${wordLength} letter words, words with ${letter.toUpperCase()}, crossword solver, word games, word puzzles, word search`}
				/>
				<meta name='robots' content='index, follow' />
				<link rel='canonical' href={`${baseUrl}/words-by-length/${wordLength}/with/${letter.toUpperCase()}`} />
			</head>
						...
						<div className='bg-white rounded-xl shadow-lg p-8 border border-gray-100'>
							<div className='bg-white border border-gray-300 rounded-xl p-8 mb-4 shadow flex flex-col gap-2'>
								...
								<p className='mb-2'>
									...
									list of all{" "}
									<a
										href={`/words-start-with/${letter.toUpperCase()}`}
									...
									. Try our{" "}
									<a
										href={`/words-by-length/5/with/${letter.toUpperCase()}`}
										className='text-blue-600 hover:underline'>
